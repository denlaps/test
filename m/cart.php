            ...
            <form class="deliveryForm">
                ...
                <section class="deliveryForm__promo">
                    ...
                    <section class="sendOrder">
                        ...
                        <span>Нажимая на кнопку «Отправить заказ», я соглашаюсь на обработку персональных данных и
                            ознакомлен(а) с условиями конфиденциальности. Если у вас есть вопросы, позвоните нам по
                            номеру 8-888-888-88-88.</span>
                    </section>
                </section>
            </form>
        </main>
