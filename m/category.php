    ...
    <!-- [HEAD] -->
        ...
        <main class="catalogPage">
            ...
            <menu class="catalogPage__menu">
                ...
                <ul>
                    <li><a id="new" href="/m/category.php?id=<?= $category_id ?>&new=1" <?php if (isset($_GET["new"])) { ?>class="active"<?php  } ?>>New</a></li>
                    <li><a id="sale" href="/m/category.php?id=<?= $category_id ?>&sale=1" <?php if (isset($_GET["sale"])) { ?>class="active"<?php  } ?>>Sale</a></li>
                    <li><a id="best" href="/m/category.php?id=<?= $category_id ?>&best=1" <?php if (isset($_GET["best"])) { ?>class="active"<?php  } ?>>Best</a></li>
                    <li><a id="all" href="/m/category.php?id=<?= $category_id ?>" <?php if (!isset($_GET["new"]) && !isset($_GET["sale"]) && !isset($_GET["best"])) { ?>class="active"<?php  } ?>>Все товары</a></li>
                </ul>
            </menu>
            <!-- [/END FILTER] -->
